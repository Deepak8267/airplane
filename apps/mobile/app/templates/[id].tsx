...
const styles = StyleSheet.create({
  screen: { flex: 1 },
  centerScreen: { flex: 1, padding: FLOW_SIZE.screenPadding, alignItems: "center", justifyContent: "center", gap: FLOW_SIZE.sectionGap, backgroundColor: "#fff7fb" },
  ...
  loadingTitle: { color: "#101828", fontFamily: MOBILE_FONT.bold, fontSize: FLOW_SIZE.pageTitle, lineHeight: FLOW_SIZE.pageTitleLine, textAlign: "center" },
  emptyCopy: { color: "#667085", fontFamily: MOBILE_FONT.regular, fontSize: FLOW_SIZE.body, lineHeight: FLOW_SIZE.bodyLine, textAlign: "center" },
  content: { gap: FLOW_SIZE.sectionGap, padding: FLOW_SIZE.screenPadding, paddingBottom: 112 },
  ...
  premiumBadge: { overflow: "hidden", borderRadius: 14, backgroundColor: "#ec0e68", color: "#ffffff", paddingHorizontal: 10, paddingVertical: 7, fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.caption, textTransform: "uppercase" },
  hero: { minHeight: 168, flexDirection: "row", alignItems: "stretch", gap: FLOW_SIZE.cardGap, borderRadius: FLOW_SIZE.cardRadius, borderWidth: 1, borderColor: "#ffffff", backgroundColor: "rgba(255,255,255,0.78)", padding: FLOW_SIZE.cardPadding, shadowColor: "#101828", shadowOpacity: 0.06, shadowRadius: 12, shadowOffset: { width: 0, height: 4 }, elevation: 2 },
  ...
  miniCardText: { fontFamily: MOBILE_FONT.bold, fontSize: 11, lineHeight: 14, textAlign: "center" },
  category: { fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.caption, lineHeight: FLOW_SIZE.captionLine, textTransform: "uppercase" },
  title: { fontFamily: MOBILE_FONT.bold, fontSize: FLOW_SIZE.headerTitle, lineHeight: FLOW_SIZE.headerTitleLine },
  copy: { fontFamily: MOBILE_FONT.regular, fontSize: FLOW_SIZE.body, lineHeight: FLOW_SIZE.bodyLine, color: "#475467" },
  featureGrid: { flexDirection: "row", gap: 8 },
  featureCard: { flex: 1, minHeight: 72, borderRadius: 18, borderWidth: 1, borderColor: "#fbcfe8", backgroundColor: "#ffffff", padding: 10, gap: 7, justifyContent: "center" },
  featureText: { color: "#101828", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.body, lineHeight: 16 },
  section: { gap: 12, borderRadius: FLOW_SIZE.cardRadius, borderWidth: 1, borderColor: "#fbcfe8", backgroundColor: "#ffffff", padding: FLOW_SIZE.cardPadding },
  sectionHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 12 },
  sectionTitle: { color: "#101828", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.sectionTitle },
  sectionMeta: { color: "#667085", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.caption, textTransform: "uppercase" },
  timeline: { gap: 10 },
  ...
  pageType: { color: "#667085", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.caption, textTransform: "uppercase" },
  pageTitle: { color: "#101828", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.sectionTitle, lineHeight: 18 },
  pageIndex: { color: "#98a2b3", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.body },
  ...
  themeName: { color: "#101828", fontFamily: MOBILE_FONT.semibold },
  themeMeta: { fontFamily: MOBILE_FONT.regular, fontSize: FLOW_SIZE.body, lineHeight: FLOW_SIZE.bodyLine },
  ...
  planNoticeTitle: { color: "#101828", fontFamily: MOBILE_FONT.semibold },
  planNoticeCopy: { color: "#344054", fontFamily: MOBILE_FONT.regular, fontSize: FLOW_SIZE.body, lineHeight: FLOW_SIZE.bodyLine },
  ...
  button: { height: FLOW_SIZE.buttonHeight, borderRadius: FLOW_SIZE.compactRadius, alignItems: "center", justifyContent: "center", backgroundColor: "#ec0e68", flexDirection: "row", gap: 8 },
