...
const styles = StyleSheet.create({
  root: { flex: 1 },
  emptyScreen: { flex: 1, padding: FLOW_SIZE.screenPadding, justifyContent: "center", gap: FLOW_SIZE.sectionGap, backgroundColor: "#fff7fb" },
  ...
  emptyTitle: { color: "#101828", fontFamily: MOBILE_FONT.bold, fontSize: FLOW_SIZE.pageTitle, lineHeight: FLOW_SIZE.pageTitleLine },
  emptyCopy: { color: "#667085", fontFamily: MOBILE_FONT.regular, fontSize: FLOW_SIZE.body, lineHeight: FLOW_SIZE.bodyLine },
  emptyButton: { height: FLOW_SIZE.buttonHeight, borderRadius: FLOW_SIZE.compactRadius, backgroundColor: "#ec0e68", alignItems: "center", justifyContent: "center", flexDirection: "row", gap: 8 },
  emptyButtonText: { color: "#ffffff", fontFamily: MOBILE_FONT.semibold, fontSize: 13 },
  screen: { flexGrow: 1, padding: FLOW_SIZE.screenPadding, paddingBottom: 28, justifyContent: "center", gap: FLOW_SIZE.sectionGap },
  ...
  previewBadgeText: { fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.caption, textTransform: "uppercase" },
  ...
  progressText: { color: "#667085", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.caption },
  phoneCard: { gap: 12, padding: FLOW_SIZE.cardPadding, borderRadius: FLOW_SIZE.cardRadius, backgroundColor: "rgba(255, 255, 255, 0.82)", borderWidth: 1, borderColor: "rgba(255, 255, 255, 0.88)", shadowColor: "#101828", shadowOpacity: 0.1, shadowRadius: 18, shadowOffset: { width: 0, height: 10 } },
  previewHeader: { minHeight: 42, flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 12 },
  previewPageType: { fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.caption, textTransform: "uppercase" },
  previewPageTitle: { fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.sectionTitle },
  previewCounter: { minWidth: 48, height: 34, borderRadius: 14, alignItems: "center", justifyContent: "center", paddingHorizontal: 10 },
  previewCounterText: { fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.caption },
  cardContent: { gap: 12 },
  ...
  recipient: { fontSize: FLOW_SIZE.caption, fontWeight: "900", textTransform: "uppercase" },
  pageLabel: { fontSize: FLOW_SIZE.caption, fontWeight: "900", textTransform: "uppercase", opacity: 0.58 },
  title: { fontSize: 25, lineHeight: 30, fontWeight: "900" },
  copy: { fontSize: FLOW_SIZE.body, lineHeight: FLOW_SIZE.bodyLine, opacity: 0.78 },
  ...
  countdownLabel: { fontSize: 8, fontWeight: "800", opacity: 0.65 },
  countdownMessage: { fontSize: FLOW_SIZE.pageTitle, fontWeight: "900" },
  options: { gap: 10 },
  ...
  optionText: { flex: 1, fontSize: FLOW_SIZE.body, fontWeight: "800" },
  ...
  watermark: { color: "#667085", textAlign: "center", fontFamily: MOBILE_FONT.medium, fontSize: FLOW_SIZE.caption },
  navigation: { flexDirection: "row", gap: 10, borderRadius: FLOW_SIZE.actionPanelRadius, borderWidth: 1, padding: 10, shadowColor: "#101828", shadowOpacity: 0.08, shadowRadius: 14, shadowOffset: { width: 0, height: 6 }, elevation: 4 },
  navIconButton: { width: FLOW_SIZE.buttonHeight, height: FLOW_SIZE.buttonHeight, borderRadius: FLOW_SIZE.compactRadius, alignItems: "center", justifyContent: "center", backgroundColor: "#ffffff", borderWidth: 1, borderColor: "#d0d5dd" },
  disabledButton: { opacity: 0.35 },
  button: { flex: 1, height: FLOW_SIZE.buttonHeight, borderRadius: FLOW_SIZE.compactRadius, flexDirection: "row", gap: 8, alignItems: "center", justifyContent: "center", shadowColor: "#101828", shadowOpacity: 0.12, shadowRadius: 10, shadowOffset: { width: 0, height: 5 }, elevation: 3 },
