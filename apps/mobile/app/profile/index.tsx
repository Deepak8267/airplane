...
const styles = StyleSheet.create({
  ...
  completionValue: { height: "100%", borderRadius: 4, backgroundColor: "#2563eb" },
  checklist: { gap: 8 },
  ...
  detailIcon: { width: 36, height: 36, borderRadius: 8, backgroundColor: "#eff4ff", alignItems: "center", justifyContent: "center" },
