...
const styles = StyleSheet.create({
  ...
  content: { flexGrow: 1, gap: FLOW_SIZE.sectionGap, padding: FLOW_SIZE.screenPadding, paddingBottom: 32 },
  ...
  eyebrow: { fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.caption, textTransform: "uppercase" },
  hero: { gap: 12, padding: FLOW_SIZE.cardPadding, borderRadius: FLOW_SIZE.cardRadius, borderWidth: 1, borderColor: "#fbcfe8", backgroundColor: "#ffffff" },
  heroIcon: { width: 56, height: 56, borderRadius: 20, backgroundColor: "#fff0f6", alignItems: "center", justifyContent: "center" },
  title: { color: "#101828", fontFamily: MOBILE_FONT.bold, fontSize: FLOW_SIZE.headerTitle, lineHeight: FLOW_SIZE.headerTitleLine },
  copy: { color: "#667085", fontFamily: MOBILE_FONT.regular, lineHeight: FLOW_SIZE.bodyLine, fontSize: FLOW_SIZE.body },
  summaryCard: { gap: 12, padding: FLOW_SIZE.cardPadding, borderRadius: FLOW_SIZE.cardRadius, borderWidth: 1, borderColor: "#fbcfe8", backgroundColor: "#ffffff" },
  ...
  summaryLabel: { color: "#667085", fontFamily: MOBILE_FONT.medium, fontSize: 9, textTransform: "uppercase" },
  summaryValue: { color: "#101828", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.body },
  checklist: { gap: 8, padding: FLOW_SIZE.cardPadding, borderRadius: FLOW_SIZE.cardRadius, borderWidth: 1, borderColor: "#fbcfe8", backgroundColor: "#ffffff" },
  checkItem: { minHeight: 38, flexDirection: "row", alignItems: "center", gap: 9 },
  checkLabel: { color: "#344054", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.body },
  linkPanel: { gap: 12, backgroundColor: "#ffffff", borderWidth: 1, borderColor: "#fbcfe8", padding: FLOW_SIZE.cardPadding, borderRadius: FLOW_SIZE.cardRadius },
  ...
  successTitle: { fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.sectionTitle },
  successSubtitle: { fontFamily: MOBILE_FONT.regular, fontSize: FLOW_SIZE.body, lineHeight: FLOW_SIZE.bodyLine },
  linkHeader: { flexDirection: "row", alignItems: "center", gap: 12 },
  linkLabel: { color: "#ec0e68", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.caption, textTransform: "uppercase" },
  link: { color: "#101828", fontFamily: MOBILE_FONT.medium, fontSize: FLOW_SIZE.body, lineHeight: 18, flexShrink: 1 },
  ...
  linkHint: { color: "#667085", fontFamily: MOBILE_FONT.regular, lineHeight: FLOW_SIZE.bodyLine, fontSize: FLOW_SIZE.body },
  actionPanel: { borderRadius: FLOW_SIZE.actionPanelRadius, borderWidth: 1, padding: 10, shadowColor: "#101828", shadowOpacity: 0.08, shadowRadius: 14, shadowOffset: { width: 0, height: 6 }, elevation: 4 },
  publishedActions: { gap: 10, borderRadius: FLOW_SIZE.actionPanelRadius, borderWidth: 1, padding: 10, shadowColor: "#101828", shadowOpacity: 0.08, shadowRadius: 14, shadowOffset: { width: 0, height: 6 }, elevation: 4 },
  actionGrid: { flexDirection: "row", gap: 10 },
  button: { height: FLOW_SIZE.buttonHeight, borderRadius: FLOW_SIZE.compactRadius, alignItems: "center", justifyContent: "center", backgroundColor: "#ec0e68", flexDirection: "row", gap: 8, shadowColor: "#101828", shadowOpacity: 0.12, shadowRadius: 10, shadowOffset: { width: 0, height: 5 }, elevation: 3 },
  buttonText: { color: "#ffffff", fontFamily: MOBILE_FONT.semibold, fontSize: 13 },
  secondaryButton: { flex: 1, height: FLOW_SIZE.buttonHeight, borderRadius: FLOW_SIZE.compactRadius, backgroundColor: "#ffffff", borderWidth: 1, borderColor: "#d0d5dd", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8 },
  secondaryButtonFull: { height: FLOW_SIZE.buttonHeight, borderRadius: FLOW_SIZE.compactRadius, backgroundColor: "#ffffff", borderWidth: 1, borderColor: "#d0d5dd", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8 },
  secondaryButtonText: { color: "#101828", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.body },
  textButton: { minHeight: 44, alignItems: "center", justifyContent: "center" },
  textButtonText: { color: "#344054", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.body },
