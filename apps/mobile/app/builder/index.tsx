...
const styles = StyleSheet.create({
  ...
  screen: { padding: FLOW_SIZE.screenPadding, gap: FLOW_SIZE.sectionGap, backgroundColor: "#f6f7fb" },
  empty: { flex: 1, padding: FLOW_SIZE.screenPadding, justifyContent: "center", gap: FLOW_SIZE.sectionGap },
  ...
  autosaveText: { fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.caption },
  title: { fontFamily: MOBILE_FONT.bold, fontSize: FLOW_SIZE.headerTitle, lineHeight: FLOW_SIZE.headerTitleLine, color: "#101828" },
  stepper: { minHeight: 72, borderRadius: 18, borderWidth: 1, borderColor: "#fbcfe8", backgroundColor: "#ffffff", flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: 10 },
  ...
  stepLabel: { color: "#344054", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.caption },
  progressCard: { minHeight: 78, borderRadius: 18, borderWidth: 1, backgroundColor: "#ffffff", flexDirection: "row", paddingVertical: 10, shadowColor: "#101828", shadowOpacity: 0.04, shadowRadius: 10, shadowOffset: { width: 0, height: 4 }, elevation: 1 },
  ...
  progressValue: { fontFamily: MOBILE_FONT.bold, fontSize: FLOW_SIZE.sectionTitle },
  progressLabel: { fontFamily: MOBILE_FONT.medium, fontSize: 9, textTransform: "uppercase" },
  sectionCard: { gap: FLOW_SIZE.cardGap, borderRadius: FLOW_SIZE.cardRadius, borderWidth: 1, borderColor: "#eaecf0", backgroundColor: "#ffffff", padding: FLOW_SIZE.cardPadding },
  ...
  sectionSubtitle: { color: "#667085", fontFamily: MOBILE_FONT.regular, fontSize: FLOW_SIZE.body, lineHeight: FLOW_SIZE.bodyLine },
  ...
  validationSummaryText: { flex: 1, color: "#b42318", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.body, lineHeight: 18 },
  field: { gap: 7 },
  label: { color: "#344054", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.body },
  input: { minHeight: FLOW_SIZE.inputHeight, borderWidth: 1, borderColor: "#d0d5dd", borderRadius: FLOW_SIZE.compactRadius, paddingHorizontal: 13, backgroundColor: "#ffffff", fontFamily: MOBILE_FONT.regular, fontSize: FLOW_SIZE.body, color: "#101828" },
  fieldError: { color: "#b42318", fontFamily: MOBILE_FONT.regular, fontSize: FLOW_SIZE.body, lineHeight: 17 },
  ...
  themeName: { flex: 1, fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.sectionTitle },
  ...
  themeFont: { fontFamily: MOBILE_FONT.medium, fontSize: FLOW_SIZE.caption, opacity: 0.65 },
  coverPanel: { gap: 10 },
  ...
  coverPlaceholder: { color: "#667085", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.body },
  photoActionRow: { flexDirection: "row", alignItems: "center", gap: 8 },
  pages: { gap: 10 },
  sectionTitle: { color: "#101828", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.sectionTitle },
  pageEditor: { padding: FLOW_SIZE.cardPadding, backgroundColor: "#ffffff", borderWidth: 1, borderColor: "#eaecf0", borderRadius: FLOW_SIZE.cardRadius, gap: FLOW_SIZE.cardGap },
  ...
  pageNumber: { color: "#101828", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.sectionTitle },
  pageType: { color: "#ec0e68", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.caption, textTransform: "uppercase" },
  pageSummary: { color: "#667085", fontFamily: MOBILE_FONT.medium, fontSize: FLOW_SIZE.body },
  ...
  photoButtonText: { color: "#ec0e68", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.body },
  ...
  correctAnswerText: { color: "#667085", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.body },
  ...
  inlineAddText: { color: "#ec0e68", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.body },
  helperText: { color: "#667085", fontFamily: MOBILE_FONT.regular, fontSize: FLOW_SIZE.body, lineHeight: FLOW_SIZE.bodyLine },
  ...
  segmentButtonText: { color: "#667085", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.body },
  ...
  presetButtonText: { color: "#344054", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.body },
  ...
  pagePicker: { backgroundColor: "#ffffff", padding: FLOW_SIZE.screenPadding, paddingBottom: 32, gap: 8, borderTopLeftRadius: 20, borderTopRightRadius: 20 },
  pagePickerHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 4 },
  pagePickerTitle: { color: "#101828", fontFamily: MOBILE_FONT.bold, fontSize: FLOW_SIZE.pageTitle, lineHeight: FLOW_SIZE.pageTitleLine },
  ...
  pageOptionTitle: { color: "#101828", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.sectionTitle },
  pageOptionDescription: { color: "#667085", fontFamily: MOBILE_FONT.regular, fontSize: FLOW_SIZE.body },
  actions: { flexDirection: "row", gap: 10, borderRadius: FLOW_SIZE.actionPanelRadius, borderWidth: 1, padding: 10, shadowColor: "#101828", shadowOpacity: 0.08, shadowRadius: 14, shadowOffset: { width: 0, height: 6 }, elevation: 4 },
  button: { flex: 1, height: FLOW_SIZE.buttonHeight, borderRadius: FLOW_SIZE.compactRadius, backgroundColor: "#ec0e68", justifyContent: "center", alignItems: "center", shadowColor: "#101828", shadowOpacity: 0.12, shadowRadius: 10, shadowOffset: { width: 0, height: 5 }, elevation: 3 },
  buttonText: { color: "#ffffff", fontFamily: MOBILE_FONT.semibold, fontSize: 13 },
  secondaryButton: { flex: 1, height: FLOW_SIZE.buttonHeight, borderRadius: FLOW_SIZE.compactRadius, backgroundColor: "#ffffff", borderWidth: 1, borderColor: "#d0d5dd", justifyContent: "center", alignItems: "center", flexDirection: "row", gap: 7 },
  secondaryButtonText: { color: "#101828", fontFamily: MOBILE_FONT.semibold, fontSize: FLOW_SIZE.body },
