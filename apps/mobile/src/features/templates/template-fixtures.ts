...
export const templateFixtures: Template[] = [
  ...
  },
  {
    ...
    slug: "friendship-quiz",
    category: "friends",
    description: "A light quiz to see how well your friend knows you.",
    thumbnailUrl: null,
    isPremium: false,
    templateType: "friendship_quiz",
    defaultTheme: {
      id: "mint",
      name: "Mint",
      background: "#f4fff8",
    ...
    defaultPages: [
      { pageType: "cover", title: "Friendship check", content: { body: "Let's see how well you know me." }, mediaUrls: [], settings: {} },
      { pageType: "quiz", title: "First question", content: { question: "What is my go-to comfort food?", answers: [{ id: "a", label: "Pizza" }, { id: "b", label: "Noodles" }] }, mediaUrls: [], settings: {} },
      { pageType: "final", title: "You made it", content: { finalMessage: "Certified friend energy." }, mediaUrls: [], settings: {} }
    ],
    isActive: true
  }
];
